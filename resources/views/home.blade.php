...
@section('content')
        ...
        <div class="main__content">
            <div class="container h-100">
                <nav class="main__nav nav-btns">
                    ...
                    <div class="nav-btns__item">
                        <a href="#posters" class="nav-btns__link">Афиша ближайших мероприятий</a>
                    </div>
                    <div class="nav-btns__item">
                        <a href="#reviews" class="nav-btns__link">Отзывы о школе фитнеса</a>
                    </div>
                    <div class="nav-btns__item">
                        <a href="#graduates" class="nav-btns__link">Фотографии с выпускниками</a>
                    </div>
                </nav>
    ...
    <div class="container-fluid banner">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="banner__title">Афиша ближайших мероприятий</h2>
                </div>
                <div class="col-6">
                    <p class="banner__desc">
    ...
    <div class="container-fluid banner">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="banner__title">Отзывы о школе фитнеса</h2>
                </div>
                <div class="col-6">
                    <p class="banner__desc">
    ...
    <div class="container-fluid banner">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="banner__title">Фотографии с выпускниками школы фитнеса</h2>
                </div>
            </div>
        </div>
    </div>
    <div class="section section__graduates graduates" id="graduates">
