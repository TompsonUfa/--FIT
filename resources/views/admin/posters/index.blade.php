...
@section('title', 'Панель администратора | Афиши')
...
@section('content')
    <div class="row-12">
        <div class="panel p-3 p-md-5 mt-5">
            ...
            <p class="panel__desc mb-3">
                Количество афиш на сайте: <span class="panel__counter">{{ $total }}</span>
            </p>
            <a href="posters/add" class="btn btn-success panel__btn mb-3">Добавить афишу
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th scope="col" class="text-center">Афиша</th>
                                    <th scope="col">Название афиши</th>
                            ...
                            <tbody>
                                @foreach ($posters as $poster)
                                    <tr data-item-id={{ $poster['id'] }}>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="{{ url('admin/posters/edit') }}{{ '/' . $poster['id'] }}"
    ...
    @push('scripts')
        @vite(['resources/sass/app.scss', 'resources/js/sidebar.js', 'resources/js/bootstrap.js', 'resources/js/delete.js'])
    @endpush
@endsection
